...
for p in page.get_drawings():
    ...
    # 条件2：粗线条（宽度>=0.72，长度>50）
    is_thick_stroke = (width >= 0.72)
    
    if not is_wall_fill and not is_thick_stroke:
        continue
    ...
    while q:
        ...
        for dx,dy in [(-1,0),(1,0),(0,-1),(0,1)]:
            ...
            if 0<=nx<gw and 0<=ny<gh and not vis[ny][nx] and not wall[ny][nx]:
                vis[ny][nx] = True; q.append((nx,ny,d+1))
    return vis
...
palette = [
    (0,0,0), (255,200,200), (200,255,200), (200,200,255),
    (255,255,200), (255,200,255), (200,255,255), (240,220,200),
]
